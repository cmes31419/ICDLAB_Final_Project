...
python utils/gen_sigmaV_conventional.py $out_fname_conventional $parallel_num $q $n $t_max $prim_poly $mode
python utils/gen_sigmaV_baseline.py $out_fname_baseline $parallel_num $q $n $t_max $prim_poly $mode
python utils/gen_sigmaV.py $out_fname $parallel_num $q $n $t_max $prim_poly $mode
