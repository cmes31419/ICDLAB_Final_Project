...
python utils/gen_sigmaV_conventional.py $q $n $t_max $prim_poly $parallel_num
python utils/gen_sigmaV_baseline.py $q $n $t_max $prim_poly $parallel_num
python utils/gen_sigmaV.py $q $n $t_max $prim_poly $parallel_num
python utils/gen_rtl.py
python utils/gen_tb.py $ntest $q $t_max $parallel_num
