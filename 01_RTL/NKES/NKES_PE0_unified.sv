...
always @(*) begin
    if (start) begin
        ...
        sigma_delay_next = gfmul0_out ^ gfmul1_out;
        b_delay_next = (branch)? sigma_poly : b_poly_in; 
    end
    ...
    if (hold) begin
        ...
        sigma_poly_next = mode ? sigma_delay : sigma_delay_next;
        b_poly_next = mode ? b_delay : b_delay_next;
    end
end
